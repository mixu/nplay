...
function CommandMode(opts) {
  ...
  function redraw() {
    ...
    // throttle clear operation to only occur every 500 ms to avoid excessive flicker while also avoiding stray characters
    // by occasionally clearing the screen
    if (lastClear < new Date().getTime() - 500) {
